<template>
    <div class="profile__address">
       <div class="grid grid-cols-1 md:grid-cols-2">
         <div>
             <div class="profile__address-item flex items-start">
               <div class="inline-block min-w-10 mr-5 fill-primary">
                   <span>
               ...
               <div class=" text-sm address-content">
                   <h3 class=" text-2xl mb-5 font-bold leading-3">Billing Address</h3>
         ...
         <div>
             <div class="profile__address-item flex items-start">
               ...
               <div class=" text-sm address-content">
                   <h3 class=" text-2xl mb-5 font-bold leading-3">Shipping Address</h3>
